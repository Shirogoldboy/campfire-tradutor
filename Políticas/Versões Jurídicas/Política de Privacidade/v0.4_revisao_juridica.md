<!--
v0.4 — REVISÃO JURÍDICA (Advogada) — base legal específica da LGPD (art. 33, VIII)
na Seção 3 e reforço de proteção a menores na Seção 5, incorporados em
10/08/2026. Aviso de restrição de idade no primeiro uso: confirmado que o
app não tem essa tela — frase removida da Seção 5 (2026-08-10).
