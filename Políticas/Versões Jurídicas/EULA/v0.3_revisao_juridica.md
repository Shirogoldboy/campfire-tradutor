...
oficial ou que cause confusão quanto à origem. Ver também o [Aviso de Direitos Autorais](aviso_direitos_autorais.md).
...
ou alteração de serviços de terceiros integrados (Seção 5). Ver também os [Termos de Uso](termos_de_uso.md).
