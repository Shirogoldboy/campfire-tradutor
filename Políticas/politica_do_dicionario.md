...
Política específica do dicionário colaborativo público (campfire-dictionary).
...
[Recomendação: considerar adicionar esse controle no Setup antes do lançamento na Play Store —
mesmo sem dados pessoais envolvidos, dar ao usuário controle sobre o que é compartilhado tende a
ser bem visto tanto pela LGPD quanto pela revisão da própria loja.]
...
- Pode ser usado, consultado, copiado ou redistribuído por qualquer pessoa, nos termos da licença
  do repositório [CONFIRMAR licença — ex: MIT/CC0].
